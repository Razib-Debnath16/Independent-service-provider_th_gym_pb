...
const Blogs = () => {
    return (
        <div>
            <h3 className='text-success mb-2 ms-3'>Q1) Different between Authorization and Authentication?</h3>
            ...
            <h3 className='text-success mb-2 ms-3'>Q2) Why are you using Firebase? What other options do you have to implement Authentication?</h3>
            ...
            <h3 className='text-success mb-2 ms-3'>Q3) What other services does firebase provide other than authentication?</h3>
            <div className='question-2'>
